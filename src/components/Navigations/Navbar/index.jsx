...
const Navbar = ({ toggle }) => {
  ...
  const navbarStyles = isHomePage 
    ? `fixed top-0 z-10 border-b-2 transition-colors duration-300 ${isScrolled ? 'bg-offWhite text-navyBlue' : 'bg-transparent text-white'}`
    : 'fixed top-0 z-10 bg-white text-navyBlue border-b-2'; // Default styles for other pages
  ...
  return (
    <div id="gsapNavDiv" className={`${navbarStyles} w-full h-16 lg:h-[74px] min-h-[68px]`}>
