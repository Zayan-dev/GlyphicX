...
const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-offWhite mt-32">
      <h1 className="text-3xl font-bold mb-6 text-center mainHeading text-transparent bg-clip-text bg-gradient-to-r from-peanut to-lightPink">Privacy Policy</h1>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Information We Collect</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">How We Use Your Information</h2>
        <ol className="list-disc list-inside space-y-2 para">
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Sharing Your Information</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Cookies</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Data Security</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Your Rights</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Changes to This Policy</h2>
        <p className='para'>
      ...
      <section className="mb-6">
        <h2 className="text-2xl text-peanut mb-3 subHeading">Contact Us</h2>
        <p className='para'>
